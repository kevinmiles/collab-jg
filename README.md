## Cisco DevNet Learning Labs: Jabber Guest Web API

These self-paced interactive tutorials provide instructions for developers to learn about the Cisco collaboration Jabber Guest Web API.
...
This repository contains information about using the Cisco collaboration Jabber Guest Web API.
